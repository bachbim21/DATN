...
import { addRow, getDepartmentOptions, getStatusesOption, options } from 'utils/globalFunc.util'; 
      ...
      >
        <Form.Item
          ...
          <Form.Item
            ...
            className='mb-5'
          >
            <Input type='file' size='small' placeholder='Nhập tên thiết bị' allowClear className='input' onChange={(e: any) => handleChangeImg(e)}/>
          </Form.Item>
          <Form.Item>
